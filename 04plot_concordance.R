...
ggsave("Figures/concordance_4_models.pdf", p, width = 10*0.8, height = 4*0.8)
...
p = d %>% 
  ...
  xlab("Path: node A - node Z") + 
  theme_tufte(ticks = F) + 
  theme(text = element_text(size = 35),# need to set font size for pixel figures
        ...
        axis.text.y = element_text(margin = margin(t = 0, r = -3, b = 0, l = 0),
                                   hjust = 0))
ggsave("Figures/concordance_4_models.png", p, width = 10*0.8, height = 4*0.8, dpi = 300)
